  ...
  const testArgs: Record<string, any> = {
    ...
    verify_passkey_registration: {
      ...
      registrationResponse: {
        id: 'dGVzdF9jcmVkZW50aWFsX2lkXzEyMzQ1Njc4OQ',
        rawId: 'dGVzdF9jcmVkZW50aWFsX2lkXzEyMzQ1Njc4OQ',
        type: 'public-key',
        response: {
          clientDataJSON: 'eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoiZEdWemRBIn0',
          attestationObject: 'o2NmbXRkbm9uZWdhdHRTdG10oGhhdXRoRGF0YVikSZYN5YgOjGh0NBcPZHZgW4_krrmihjLHmVzzuoMdl2NBAAAABAAAAAAAAAAAAAAAAAAAAAAAIGN0ZXN0X2NyZWRlbnRpYWxfaWRfMTIzNDU2Nzg5',
          transports: ['internal'],
        },
      },
    },
