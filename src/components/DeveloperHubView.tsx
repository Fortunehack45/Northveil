  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-6 pb-12 w-full font-mono select-none">
      ...
      {activeTab === 'mcpServer' && (() => {
        ...
        const openApiUrl = `https://00d85d5271df4ccc-102-89-85-123.serveousercontent.com/openapi.json?wallet_address=${activeAddress}`;
        const tunnelBaseUrl = `https://00d85d5271df4ccc-102-89-85-123.serveousercontent.com`;
        const uniqueSseUrl = `https://00d85d5271df4ccc-102-89-85-123.serveousercontent.com/sse?wallet_address=${activeAddress}`;
